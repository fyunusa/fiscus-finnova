# Content Guide: 내 대출 현황

## Page Location
`loan/my-loans`

## Design Source
**File**: `../02_핀노바_유저UI/02_서비스_흐름/25-10-14 핀노바_대출자_시뮬레이션.md`
**Section**: `my_loans`
...
1. Open the design file at `../02_핀노바_유저UI/02_서비스_흐름/25-10-14 핀노바_대출자_시뮬레이션.md`
2. Find the section labeled `my_loans`
