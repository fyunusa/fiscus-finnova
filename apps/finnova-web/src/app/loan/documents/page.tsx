...
const documents: Document[] = [
  ...
  },
  {
    ...
    category: 'required',
    name: '등기부등본',
    description: '대출받을 부동산의 현재 등기부등본',
    isRequired: true,
    fileType: 'PDF',
    notes: [
      '최근 1개월 이내 발급 문서',
  ...
  // 담보 관련 (Collateral)
  {
    ...
    category: 'collateral',
    name: '부동산 평가 보고서',
    description: '전문기관의 부동산 가격 평가 보고서',
    isRequired: false,
    fileType: 'PDF',
    notes: [
      '저희 지정 평가사 이용 가능',
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold mb-2">필수 서류</h1>
            <p className="text-blue-100 text-lg">
              대출 신청에 필요한 서류를 확인하고 준비하세요
            </p>
          </div>
        </div>
