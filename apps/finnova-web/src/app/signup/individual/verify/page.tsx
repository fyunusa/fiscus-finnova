        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-white px-4 py-8">
          <Card className="w-full max-w-md">
            ...
            <div className="mb-8 pb-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 mt-2">카카오 계정으로 본인인증을 진행합니다</p>
            </div>

            {error && <Alert type="error" className="mb-6">{error}</Alert>}

            {/* Kakao verification button */}
            <div className="space-y-4">
              ...
              >
                {loading ? (
                  <div
                    className="w-5 h-5 border-2 border-black/30 border-t-black/80 rounded-full animate-spin"
                  />
                ) : (
                ...
                {loading ? '카카오로 이동 중...' : '카카오로 본인인증'}
              </button>

              <p className="text-xs text-gray-500 text-center">
                카카오 계정의 프로필 정보로 빠르게 인증합니다
              </p>
            </div>
